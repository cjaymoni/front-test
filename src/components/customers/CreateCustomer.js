        ...
        >
          ...
          <DialogContent>
            ...
            <FormGroup>
              ...
              />
              <label className="form-control-label">Customer email</label>
              <Input
                disabled="true"
                className="form-control-alternative"
                name="category name"
              ...
              />
              <label className="form-control-label">Customer contact</label>
              <Input
                disabled="true"
                className="form-control-alternative"
                name="category name"
              ...
              />
              <label className="form-control-label">Customer arrears</label>
              <Input
                disabled="true"
                className="form-control-alternative"
                name="category name"
